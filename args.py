...
### Some paths
train_file = '/home/bjoshi/deepcl-data/cyclegan_synth/final_tf_train.txt'  # The path of the training txt file.
val_file = '/home/bjoshi/YOLOv3_TensorFlow/data/my_data/train.txt'  # The path of the validation txt file.
